...
with imcol3:
    st.write("")
st.markdown("<p style='text-align: center; color: black; margin-top: -20px ; font-size:25px;'><span style='font-weight: bold'>ChatGPT Application: </span>ChatGPT Cheatsheet</p>", unsafe_allow_html=True)
